...
//    exporter depuis un fichier `'use client'`. Les produits sont chargés via
//    useParams() + apiClient.get() côté client (cf. useEffect dans le composant).
//    Pas de régression : la page était déjà full-client.
