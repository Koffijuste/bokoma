...
'use client';
// ✅ Force le static rendering pour Capacitor. La config (dynamic = 'force-static'
//    + generateStaticParams) est dans ./layout.tsx car Next.js interdit de les
//    exporter depuis un fichier `'use client'`. L'orderId est lu via
//    useParams() et la commande est vérifiée via apiClient côté client.

import React, { useState, useEffect, Suspense } from 'react';
import { useParams, useRouter } from 'next/navigation';
import Link from 'next/link';
// ⚠️ On alias `next/dynamic` en `nextDynamic` car `dynamic` est réservé
//    par la config route segment Next.js (export const dynamic = ...).
